...
- [ ] [GX-418] `gix message changelog` should suppress workflow logging (TASK_PLAN/TASK_APPLY) and print only the generated changelog, but current runs still emit workflow logs on stdout.
