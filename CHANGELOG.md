...
### Bug Fixes 🐛
- Stopped semantic repair after one failed provider round. Kept validation feedback for returned candidate rejection. Preserved typed LLM Proxy HTTP status and exact rollback.
