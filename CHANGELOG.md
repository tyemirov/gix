...
- Added an `ensure-lines` file mode for workflow-managed files so recipes like the gitignore preset can append missing entries without overwriting existing content.
