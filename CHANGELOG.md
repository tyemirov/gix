...
- Renamed the `branch-default` command to `default`, updated workflow/config/docs/tests to the new path, and kept `branch-default` as a deprecated alias with warnings.
