...
- `gix default <target-branch> [--roots <dir>...] [-y]`
 - Promotes the default branch across repositories. Gix closes a pull request only when its head repository and head branch match the target repository and branch. Gix changes the base of other pull requests.
