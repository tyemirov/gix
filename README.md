...
- `gix default <target-branch> [--roots <dir>...] [-y]`
 - Promotes the default branch across repositories. Gix closes each open pull request from the new default branch. Gix changes the base of other pull requests.
