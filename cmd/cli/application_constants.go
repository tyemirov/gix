...
const (
	...
	llmMaxCompletionTokensOptionKeyConstant                       = "max_completion_tokens"
	llmTemperatureOptionKeyConstant                               = "temperature"
	llmTimeoutSecondsOptionKeyConstant                            = "timeout_seconds"
	...
	webLaunchURLTemplateConstant                                  = "http://%s:%d"
	webLaunchMessageTemplateConstant                              = "gix web interface available at %s\n"
	webAddressTemplateConstant                                    = "%s:%d"
