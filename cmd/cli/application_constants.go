...
const (
	...
	configurationInitializationCommandLongDescriptionConstant        = "init writes the embedded default configuration to ./config.yaml or $HOME/.gix/config.yaml."
	...
	configurationInitializationLocalFlagNameConstant                 = "local"
	configurationInitializationLocalFlagUsageConstant                = "Write ./config.yaml in the current working directory."
	configurationInitializationUserFlagNameConstant                  = "user"
	configurationInitializationUserFlagUsageConstant                 = "Write $HOME/.gix/config.yaml."
	configurationInitializationScopeConflictErrorConstant            = "choose either --local or --user"
	...
	llmConfigurationKeyConstant                                      = "llm"
	llmTransportOptionKeyConstant                                    = "transport"
	llmProviderOptionKeyConstant                                     = "provider"
	llmAPIKeyEnvOptionKeyConstant                                    = "api_key_env"
	llmBaseURLOptionKeyConstant                                      = "base_url"
