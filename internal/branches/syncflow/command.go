...
const (
	...
	commandLongDescriptionConstant  = "sync keeps a workspace aligned with explicitly targeted branches and PR-backed work branches. " +
		...
		"Before fetch or content, index, ref, or checkout mutation, strict sync repairs canonical Git worktree linkage, then resolves exact per-worktree administrative paths and rejects operator-owned merge, revert, cherry-pick, rebase, apply-mailbox, bisect, sequencer, or unmerged-index state; ordinary refs with administrative names do not count. " +
