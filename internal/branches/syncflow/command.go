...
const (
	...
	commandLongDescriptionConstant  = "sync keeps a workspace aligned with explicitly targeted branches and PR-backed work branches. " +
		...
		"Before fetch or mutation, strict sync resolves exact per-worktree Git administrative paths and rejects operator-owned merge, revert, cherry-pick, rebase, apply-mailbox, bisect, sequencer, or unmerged-index state; ordinary refs with administrative names do not count. " +
