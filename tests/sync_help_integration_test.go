...
func TestSyncHelpDescribesMissingBranchCurrentHeadContract(testInstance *testing.T) {
	...
	require.Contains(testInstance, output, "Each dirty-cluster request checkpoints the active checkout, HEAD, exact index, and staged paths before waiting for the model.")
